...
import { MdOutlineAssignmentTurnedIn, MdOutlineOndemandVideo, MdNavigateNext } from "react-icons/md";
          ...
          <Link
            ...
            className={`flex items-center gap-2 rounded-md px-3 py-2 text-sm font-medium ${
              isActive("/admin")
                ...
                : "text-gray-700 hover:bg-muted hover:text-pink-600"
            }`}
            prefetch={false}
          >
            ...
            <Sheet>
              ...
              <SheetContent side="left" className="sm:max-w-xs">
                <nav className="grid gap-6 text-lg font-medium">
                  ...
                  <Link
                    href="#"
                    className="flex items-center gap-4 px-2.5 text-muted-foreground hover:text-pink-600"
                    prefetch={false}
                  >
